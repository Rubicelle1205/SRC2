...
namespace DataAccess
{
    ...
    {
        _EC_NotMatchData = 0x1001,
        //表示 Key 重複
        _EC_UniqueViolation = 0x1002,
        _EC_NotAffect = 0x1003
    }

    public delegate void DBAccessException(DbExecuteInfo DAException);
    ...
    public abstract class DataAccessBase
    {
        ...
        public DataAccessBase()
        {
            ...
            this._ConnectionString = config.GetValue<string>("ConnectionString:DefaultDatabase");
