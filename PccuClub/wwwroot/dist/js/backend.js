$(function () {
    ...
    if ((location.pathname).indexOf("Personal") >= 0 || (location.pathname).indexOf("RoleMang") >= 0) {
        //###############以下為通用fun#######################//
        ...
        //###############以下為特定頁面fun#######################//
        if ((location.pathname).indexOf("admin_mang.") >= 0 || (location.pathname).indexOf("Personal") >= 0 || (location.pathname).indexOf("RoleMang") >= 0) {
            // 密碼驗證
