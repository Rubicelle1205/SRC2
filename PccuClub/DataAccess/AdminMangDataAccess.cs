...
namespace WebPccuClub.DataAccess
{
    ...
    public class AdminMangDataAccess : BaseAccess
    {

        /// <summary> 查詢結果 </summary>
        public List<AdminMangResultModel> GetSearchResult(AdminMangConditionModel model)
        {
...
";
            ...
            (DbExecuteInfo info, IEnumerable<AdminMangResultModel> entitys) dbResult = DbaExecuteQuery<AdminMangResultModel>(CommandText, parameters, true, DBAccessException);

            if (dbResult.info.isSuccess && dbResult.entitys.Count() > 0)
                return dbResult.entitys.ToList();

            return new List<AdminMangResultModel>();
        }

        /// <summary>取得編輯資料 </summary>
        public AdminMangEditModel GetEditData(string LoginId)
        {
            string CommandText = string.Empty;
            DataSet ds = new DataSet();
...
AND (A.LoginId = @LoginId)";
            ...
            (DbExecuteInfo info, IEnumerable<AdminMangEditModel> entitys) dbResult = DbaExecuteQuery<AdminMangEditModel>(CommandText, parameters, true, DBAccessException);
        ...
        public DbExecuteInfo InsertData(AdminMangViewModel vm, UserInfo LoginUser, string EncryptPw)
        {
        ...
        public DbExecuteInfo InsertLifeClass(AdminMangViewModel vm, UserInfo LoginUser)
        {
            DbExecuteInfo ExecuteResult = new DbExecuteInfo();
            DBAParameter parameters = new DBAParameter();
        ...
        public DbExecuteInfo InsertRole(AdminMangViewModel vm, UserInfo LoginUser)
        {
            DbExecuteInfo ExecuteResult = new DbExecuteInfo();
            DBAParameter parameters = new DBAParameter();
        ...
        public DbExecuteInfo UpdateData(AdminMangViewModel vm, UserInfo LoginUser, string EncryptPw)
        {
            DbExecuteInfo ExecuteResult = new DbExecuteInfo();
            DBAParameter parameters = new DBAParameter();
        ...
        /// <summary> 修改組別資料 </summary>
        public DbExecuteInfo UpdateLifeClass(AdminMangViewModel vm, UserInfo LoginUser)
        {
            DbExecuteInfo ExecuteResult = new DbExecuteInfo();
            DBAParameter parameters = new DBAParameter();
        ...
        /// <summary> 修改角色資料 </summary>
        public DbExecuteInfo UpdateRole(AdminMangViewModel vm, UserInfo LoginUser)
        {
            DbExecuteInfo ExecuteResult = new DbExecuteInfo();
            DBAParameter parameters = new DBAParameter();
        ...
        public List<AdminMangResultModel> GetExportResult(AdminMangConditionModel model)
        {
            string CommandText = string.Empty;
            DataSet ds = new DataSet();
