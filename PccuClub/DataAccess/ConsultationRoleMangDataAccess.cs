...
namespace WebPccuClub.DataAccess
{
    ...
    public class ConsultationRoleMangDataAccess : BaseAccess
    {

        /// <summary> 查詢結果 </summary>

        public List<ConsultationRoleMangResultModel> GetSearchResult(ConsultationRoleMangConditionModel model)
        {
...
";
            ...
            (DbExecuteInfo info, IEnumerable<ConsultationRoleMangResultModel> entitys) dbResult = DbaExecuteQuery<ConsultationRoleMangResultModel>(CommandText, parameters, true, DBAccessException);

            if (dbResult.info.isSuccess && dbResult.entitys.Count() > 0)
                return dbResult.entitys.ToList();

            return new List<ConsultationRoleMangResultModel>();
        }
        ...
        public ConsultationRoleMangEditModel GetEditData(string RoleId)
        {
            string CommandText = string.Empty;
            DataSet ds = new DataSet();
        ...
        public DbExecuteInfo InsertData(ConsultationRoleMangViewModel vm, UserInfo LoginUser)
        {
        ...
        public DbExecuteInfo InsertFunData(ConsultationRoleMangViewModel vm)
        {
            DbExecuteInfo ExecuteResult = new DbExecuteInfo();
            DBAParameter parameters = new DBAParameter();
        ...
        public DbExecuteInfo UpdateData(ConsultationRoleMangViewModel vm, UserInfo LoginUser)
        {
            DbExecuteInfo ExecuteResult = new DbExecuteInfo();
            DBAParameter parameters = new DBAParameter();
        ...
        public DbExecuteInfo UpdateFunData(ConsultationRoleMangViewModel vm, string[] arrFun)
        {
            DbExecuteInfo ExecuteResult = new DbExecuteInfo();
            DBAParameter parameters = new DBAParameter();
