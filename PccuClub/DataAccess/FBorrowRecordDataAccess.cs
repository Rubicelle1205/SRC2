...
AND BorrowMainID = @BorrowMainID";
        ...
        public DbExecuteInfo InsertMainData(FBorrowRecordViewModel vm, UserInfo LoginUser, out DataTable dt)
        {
            ...
            parameters.Add("@UseSDate", vm.CreateModel.UseSDate?.ToString("yyyy-MM-dd"));
            parameters.Add("@UseEDate", vm.CreateModel.UseEDate?.ToString("yyyy-MM-dd"));
            parameters.Add("@TakeSDate", vm.CreateModel.TakeSDate?.ToString("yyyy-MM-dd"));
            parameters.Add("@TakeEDate", vm.CreateModel.TakeEDate?.ToString("yyyy-MM-dd"));
