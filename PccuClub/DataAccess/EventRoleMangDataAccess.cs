...
namespace WebPccuClub.DataAccess
{
    ...
    public class EventRoleMangDataAccess : BaseAccess
    {

        /// <summary> 查詢結果 </summary>

        public List<EventRoleMangResultModel> GetSearchResult(EventRoleMangConditionModel model)
        {
...
";
            ...
            (DbExecuteInfo info, IEnumerable<EventRoleMangResultModel> entitys) dbResult = DbaExecuteQuery<EventRoleMangResultModel>(CommandText, parameters, true, DBAccessException);

            if (dbResult.info.isSuccess && dbResult.entitys.Count() > 0)
                return dbResult.entitys.ToList();

            return new List<EventRoleMangResultModel>();
        }
        ...
        public EventRoleMangEditModel GetEditData(string RoleId)
        {
            string CommandText = string.Empty;
            DataSet ds = new DataSet();
            ...
            (DbExecuteInfo info, IEnumerable<EventRoleMangEditModel> entitys) dbResult = DbaExecuteQuery<EventRoleMangEditModel>(CommandText, parameters, true, DBAccessException);
        ...
        public DbExecuteInfo InsertData(EventRoleMangViewModel vm, UserInfo LoginUser)
        {
        ...
        public DbExecuteInfo InsertFunData(EventRoleMangViewModel vm)
        {
            DbExecuteInfo ExecuteResult = new DbExecuteInfo();
            DBAParameter parameters = new DBAParameter();
        ...
        public DbExecuteInfo UpdateData(EventRoleMangViewModel vm, UserInfo LoginUser)
        {
            DbExecuteInfo ExecuteResult = new DbExecuteInfo();
            DBAParameter parameters = new DBAParameter();
        ...
        public DbExecuteInfo UpdateFunData(EventRoleMangViewModel vm, string[] arrFun)
        {
            DbExecuteInfo ExecuteResult = new DbExecuteInfo();
            DBAParameter parameters = new DBAParameter();
