...
namespace WebPccuClub.Models
{
    public class ActFinishMangViewModel
    {
        ...
        public ActFinishMangPrintDetailModel PrintDetailModel { get; set; }

        public List<ActFinishMangPrintDetailNamesModel> PrintNamesModel { get; set; }
    ...
    public class ActFinishMangPrintDetailModel
    {
        public List<PersonModel> PersonModel = new List<PersonModel>();
    ...
    public class ActFinishMangPrintDetailNamesModel
    {
