...
namespace WebPccuClub.Models
{
    public class ClubActReportViewModel
    {
        ...
        public ClubActReportReturnModel ReturnModel { get; set; }
    ...
    public class ClubActReportReturnModel
    {
		/// <summary>ID</summary>
		[DisplayName("ID")]
		public string? ActID { get; set; }
		...
		/// <summary>活動報備編號ActSectionId</summary>
		[DisplayName("活動報備編號ActSectionId")]
		public string? ActSectionID { get; set; }
