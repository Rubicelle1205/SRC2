...
{
    public class BorrowResourceListMangViewModel
    {
        [DisplayName("檔案上傳")]
        [UIHint("_UploadFile")]
        public IFormFile? File { get; set; }

        public BorrowResourceListMangConditionModel ConditionModel { get; set; }

        public List<BorrowResourceListMangResultModel> ResultModel { get; set; }

        public BorrowResourceListMangEditModel EditModel { get; set; }

        public BorrowResourceListMangResultDetailModel ResultDetailModel { get; set; }

        public List<BorrowResourceListMangResourceResultModel> ResourceResultModel { get; set; }

        public List<BorrowResourceListMangResourceBorrowedModel> ResourceBorrowedResultModel { get; set; }
    }

    public class BorrowResourceListMangConditionModel
    {
        public BorrowResourceListMangConditionModel()
        {
            this.Page = 0;
            this.PageSize = 10;
            this.TotalCount = 0;
    ...
    public class BorrowResourceListMangResultModel
    {
        /// <summary>ID</summary>
        [DisplayName("ID")]
    ...
    public class BorrowResourceListMangResultDetailModel
    {
        public List<BorrowResourceListMangResultDetailResourceModel> LstResource = new List<BorrowResourceListMangResultDetailResourceModel>();
    ...
    public class BorrowResourceListMangResultDetailResourceModel
    {
    ...
    public class BorrowResourceListMangResourceResultModel
    {
        /// <summary>ID</summary>
        [DisplayName("ID")]
    ...
    public class BorrowResourceListMangResourceBorrowedModel
    {
        /// <summary>ID</summary>
        [DisplayName("ID")]
        public string? MainResourceID { get; set; }
    ...
    public class BorrowResourceListMangEditModel
    {
        public List<BorrowResourceListMangEditDetailModel> LstDetail = new List<BorrowResourceListMangEditDetailModel>();
    ...
    public class BorrowResourceListMangEditDetailModel
    {
        /// <summary>資源名稱</summary>
        [DisplayName("資源名稱")]
        public string? MainResourceID { get; set; }
