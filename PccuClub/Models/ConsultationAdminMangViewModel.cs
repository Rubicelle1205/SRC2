...
{
    public class ConsultationAdminMangViewModel
    {
        [DisplayName("檔案上傳")]
        [UIHint("_UploadFile")]
        public IFormFile? File { get; set; }

        public ConsultationAdminMangConditionModel ConditionModel { get; set; }

        public List<ConsultationAdminMangResultModel> ResultModel { get; set; }

        public ConsultationAdminMangCreateModel CreateModel { get; set; }

        public ConsultationAdminMangEditModel EditModel { get; set; }
    }

    public class ConsultationAdminMangConditionModel
    {
        public ConsultationAdminMangConditionModel()
        {
            this.Page = 0;
            this.PageSize = 10;
            this.TotalCount = 0;
    ...
    public class ConsultationAdminMangResultModel
    {
        /// <summary>管理員帳號</summary>
        [DisplayName("管理員帳號")]
        public string? LoginId { get; set; }
    ...
    public class ConsultationAdminMangCreateModel
    {
    ...
    public class ConsultationAdminMangEditModel
    {
        public List<string> LstCanUseFun = new List<string>();
