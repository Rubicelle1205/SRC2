...
namespace WebPccuClub.Models
{
    public class HolisticPassportMangViewModel
    {
        ...
        public HolisticPassportMangConditionModel ConditionModel { get; set; }

        public List<HolisticPassportMangResultModel> ResultModel { get; set; }

        public HolisticPassportMangCreateModel CreateModel { get; set; }
    ...
    {
        public HolisticPassportMangConditionModel()
        {
            this.Page = 0;
            this.PageSize = 10;
            this.TotalCount = 0;
    ...
    public class HolisticPassportMangCreateModel
    {
        /// <summary>學年度</summary>
        [DisplayName("學年度")]
        public string? SchoolYear { get; set; }
    ...
    public class HolisticPassportMangEditModel
    {
    ...
    public class HolisticPassportMangExcelModel
    {
        public string? ID { get; set; }
    ...
    public class HolisticPassportMangExcelHeaderModel
    {
        public string? ID { get; set; }
