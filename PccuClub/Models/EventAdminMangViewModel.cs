...
{
    public class EventAdminMangViewModel
    {
        [DisplayName("檔案上傳")]
        [UIHint("_UploadFile")]
        public IFormFile? File { get; set; }

        public EventAdminMangConditionModel ConditionModel { get; set; }

        public List<EventAdminMangResultModel> ResultModel { get; set; }

        public EventAdminMangCreateModel CreateModel { get; set; }

        public EventAdminMangEditModel EditModel { get; set; }
    }

    public class EventAdminMangConditionModel
    {
        public EventAdminMangConditionModel()
        {
            this.Page = 0;
            this.PageSize = 10;
            this.TotalCount = 0;
    ...
    public class EventAdminMangResultModel
    {
        /// <summary>管理員帳號</summary>
        [DisplayName("管理員帳號")]
        public string? LoginId { get; set; }
    ...
    public class EventAdminMangCreateModel
    {
        ...
        /// <summary>角色-案件管理系統</summary>
        [DisplayName("角色-案件管理系統")]
    ...
    public class EventAdminMangEditModel
    {
        public List<string> LstCanUseFun = new List<string>();
