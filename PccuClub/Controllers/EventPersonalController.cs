...
namespace WebPccuClub.Controllers
{
    ...
    public class EventPersonalController : BaseController
    {
        ReturnViewModel vmRtn = new ReturnViewModel();
        EventPersonalDataAccess dbAccess = new EventPersonalDataAccess();

        [Log(LogActionChineseName.首頁)]
        public IActionResult Index()
        {
            EventPersonalViewModel vm = new EventPersonalViewModel();
            vm.EditModel = dbAccess.GetSearchResult(LoginUser.LoginId).FirstOrDefault();
            return View(vm);
        }

        [Log(LogActionChineseName.編輯儲存)]
        public IActionResult EditOldData(EventPersonalViewModel vm)
        {
            ...
            try
            {
                ...
                var dbResult = dbAccess.UpdateEventPersonalData(EncryptPw, vm.EditModel, LoginUser);
        ...
        private bool ChkData(EventPersonalEditModel editModel, out string msg)
        {
            msg = string.Empty;
