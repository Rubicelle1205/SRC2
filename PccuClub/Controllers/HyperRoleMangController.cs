...
namespace WebPccuClub.Controllers
{
    ...
    public class HyperRoleMangController : BaseController
    {
        ReturnViewModel vmRtn = new ReturnViewModel();
        HyperRoleMangDataAccess dbAccess = new HyperRoleMangDataAccess();
        AuthManager auth = new AuthManager();

        private readonly IHostingEnvironment hostingEnvironment;

        public HyperRoleMangController(IHostingEnvironment _hostingEnvironment)
        {
        ...
        public IActionResult Index()
        {
            ...
            vm.ConditionModel = new HyperRoleMangConditionModel();
        ...
        public IActionResult Edit(string submitBtn, HyperRoleMangViewModel vm)
        {
        ...
        public IActionResult GetSearchResult(HyperRoleMangViewModel vm)
        {
            ...
            foreach (HyperRoleMangResultModel item in vm.ResultModel)
            {
            ...
            if (vm.ConditionModel.MenuNode != null) {
                ...
                List<HyperRoleMangResultModel> oResult = new List<HyperRoleMangResultModel>();
        ...
        [ValidateInput(false)]
        public IActionResult SaveNewData(HyperRoleMangViewModel vm)
        {
            try
            {
        ...
        [ValidateInput(false)]
        public IActionResult EditOldData(HyperRoleMangViewModel vm)
        {
            try
            {
                dbAccess.DbaInitialTransaction();
