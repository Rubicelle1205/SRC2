...
namespace WebPccuClub.Controllers
{
    ...
    public class HyperPersonalController : BaseController
    {
        ReturnViewModel vmRtn = new ReturnViewModel();
        HyperPersonalDataAccess dbAccess = new HyperPersonalDataAccess();

        [Log(LogActionChineseName.首頁)]
        public IActionResult Index()
        {
            HyperPersonalViewModel vm = new HyperPersonalViewModel();
            vm.EditModel = dbAccess.GetSearchResult(LoginUser.LoginId).FirstOrDefault();
            return View(vm);
        }

        [Log(LogActionChineseName.編輯儲存)]
        public IActionResult EditOldData(HyperPersonalViewModel vm)
        {
            ...
            try
            {
                ...
                var dbResult = dbAccess.UpdateHyperPersonalData(EncryptPw, vm.EditModel, LoginUser);
        ...
        private bool ChkData(HyperPersonalEditModel editModel, out string msg)
        {
            msg = string.Empty;
