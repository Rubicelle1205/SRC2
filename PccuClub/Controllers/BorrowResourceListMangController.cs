...
namespace WebPccuClub.Controllers
{
    ...
    public class BorrowResourceListMangController : BaseController
    {
        ReturnViewModel vmRtn = new ReturnViewModel();
        BorrowResourceListMangDataAccess dbAccess = new BorrowResourceListMangDataAccess();
        UploadUtil upload = new UploadUtil();

        private readonly IHostingEnvironment hostingEnvironment;

        public BorrowResourceListMangController(IHostingEnvironment _hostingEnvironment)
        {
        ...
        public IActionResult Index()
        {
            ...
            BorrowResourceListMangViewModel vm = new BorrowResourceListMangViewModel();
            vm.ConditionModel = new BorrowResourceListMangConditionModel();
            return View();
        }
        ...
        public IActionResult GetSearchResult(BorrowResourceListMangViewModel vm)
        {
        ...
        [LogAttribute(LogActionChineseName.查詢)]
        public IActionResult GetSearchResourceResult(BorrowResourceListMangViewModel vm)
        {
            ...
            foreach (BorrowResourceListMangResourceResultModel item in vm.ResourceResultModel)
            {
                int diffAmt = 0;
                string MainResourceID = item.MainResourceID;

                List<BorrowResourceListMangResourceBorrowedModel>  LstDiff = vm.ResourceBorrowedResultModel.Where(x => x.MainResourceID == MainResourceID).ToList();

                foreach (BorrowResourceListMangResourceBorrowedModel item2 in LstDiff)
                {
        ...
        public IActionResult Edit(string submitBtn, BorrowResourceListMangViewModel vm)
        {
