...
namespace WebPccuClub.Controllers
{
    ...
    public class ConsultationPersonalController : BaseController
    {
        ReturnViewModel vmRtn = new ReturnViewModel();
        ConsultationPersonalDataAccess dbAccess = new ConsultationPersonalDataAccess();

        [Log(LogActionChineseName.首頁)]
        public IActionResult Index()
        {
            ConsultationPersonalViewModel vm = new ConsultationPersonalViewModel();
            vm.EditModel = dbAccess.GetSearchResult(LoginUser.LoginId).FirstOrDefault();
            return View(vm);
        }

        [Log(LogActionChineseName.編輯儲存)]
        public IActionResult EditOldData(ConsultationPersonalViewModel vm)
        {
            ...
            try
            {
                ...
                var dbResult = dbAccess.UpdateConsultationPersonalData(EncryptPw, vm.EditModel, LoginUser);
        ...
        private bool ChkData(ConsultationPersonalEditModel editModel, out string msg)
        {
            msg = string.Empty;
