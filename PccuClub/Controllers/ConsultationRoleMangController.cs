...
namespace WebPccuClub.Controllers
{
    ...
    public class ConsultationRoleMangController : BaseController
    {
        ReturnViewModel vmRtn = new ReturnViewModel();
        ConsultationRoleMangDataAccess dbAccess = new ConsultationRoleMangDataAccess();
        AuthManager auth = new AuthManager();

        private readonly IHostingEnvironment hostingEnvironment;

        public ConsultationRoleMangController(IHostingEnvironment _hostingEnvironment)
        {
        ...
        public IActionResult Index()
        {
            ...
            vm.ConditionModel = new ConsultationRoleMangConditionModel();
        ...
        public IActionResult Edit(string submitBtn, ConsultationRoleMangViewModel vm)
        {
        ...
        public IActionResult GetSearchResult(ConsultationRoleMangViewModel vm)
        {
            ...
            foreach (ConsultationRoleMangResultModel item in vm.ResultModel)
            {
            ...
            if (vm.ConditionModel.MenuNode != null) {
                ...
                List<ConsultationRoleMangResultModel> oResult = new List<ConsultationRoleMangResultModel>();
        ...
        [ValidateInput(false)]
        public IActionResult SaveNewData(ConsultationRoleMangViewModel vm)
        {
            try
            {
        ...
        [ValidateInput(false)]
        public IActionResult EditOldData(ConsultationRoleMangViewModel vm)
        {
            try
            {
                dbAccess.DbaInitialTransaction();
