...
{
    public class EventHomeController : BaseController
    {
        private readonly ILogger<EventHomeController> _logger;

        public EventHomeController(ILogger<EventHomeController> logger)
        {
            _logger = logger;
        }
        ...
        public IActionResult Index()
        {
            ...
            List<FunInfo> LstFunInfo = LoginUser.UserRoleFun.Where(x => x.SystemCode == "03" && x.Url != "").ToList();
