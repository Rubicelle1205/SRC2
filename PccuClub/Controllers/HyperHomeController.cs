...
{
    public class HyperHomeController : BaseController
    {
        private readonly ILogger<HyperHomeController> _logger;

        public HyperHomeController(ILogger<HyperHomeController> logger)
        {
            _logger = logger;
        }
