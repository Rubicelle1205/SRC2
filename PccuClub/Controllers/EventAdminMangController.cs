...
namespace WebPccuClub.Controllers
{
    ...
    public class EventAdminMangController : BaseController
    {
        ReturnViewModel vmRtn = new ReturnViewModel();
        EventAdminMangDataAccess dbAccess = new EventAdminMangDataAccess();
        AuthManager auth = new AuthManager();

        private readonly IHostingEnvironment hostingEnvironment;

        public EventAdminMangController(IHostingEnvironment _hostingEnvironment)
        {
        ...
        public IActionResult Index()
        {
            ...
            EventAdminMangViewModel vm = new EventAdminMangViewModel();
            vm.ConditionModel = new EventAdminMangConditionModel();
        ...
        public IActionResult Create()
        {
            ...
            EventAdminMangViewModel vm = new EventAdminMangViewModel();
            vm.CreateModel = new EventAdminMangCreateModel();
            return View(vm);
        }

        [Log(LogActionChineseName.編輯)]
        public IActionResult Edit(string submitBtn, EventAdminMangViewModel vm)
        {
        ...
        public IActionResult GetSearchResult(EventAdminMangViewModel vm)
        {
        ...
        [ValidateInput(false)]
        public IActionResult SaveNewData(EventAdminMangViewModel vm)
        {
            try
            {
        ...
        [ValidateInput(false)]
        public IActionResult EditOldData(EventAdminMangViewModel vm)
        {
            try
            {
                dbAccess.DbaInitialTransaction();
