...
namespace WebPccuClub.Controllers
{
    ...
    public class BorrowPersonalController : BaseController
    {
        ReturnViewModel vmRtn = new ReturnViewModel();
        BorrowPersonalDataAccess dbAccess = new BorrowPersonalDataAccess();

        [Log(LogActionChineseName.首頁)]
        public IActionResult Index()
        {
            BorrowPersonalViewModel vm = new BorrowPersonalViewModel();
            vm.EditModel = dbAccess.GetSearchResult(LoginUser.LoginId).FirstOrDefault();
            return View(vm);
        }

        [Log(LogActionChineseName.編輯儲存)]
        public IActionResult EditOldData(BorrowPersonalViewModel vm)
        {
            ...
            try
            {
                ...
                var dbResult = dbAccess.UpdateBorrowPersonalData(EncryptPw, vm.EditModel, LoginUser);
        ...
        private bool ChkData(BorrowPersonalEditModel editModel, out string msg)
        {
            msg = string.Empty;
