...
namespace WebPccuClub.Controllers
{
    ...
    public class EventRoleMangController : BaseController
    {
        ReturnViewModel vmRtn = new ReturnViewModel();
        EventRoleMangDataAccess dbAccess = new EventRoleMangDataAccess();
        AuthManager auth = new AuthManager();

        private readonly IHostingEnvironment hostingEnvironment;

        public EventRoleMangController(IHostingEnvironment _hostingEnvironment)
        {
        ...
        public IActionResult Index()
        {
            ...
            EventRoleMangViewModel vm = new EventRoleMangViewModel();
            vm.ConditionModel = new EventRoleMangConditionModel();
        ...
        public IActionResult Create()
        {
            ...
            EventRoleMangViewModel vm = new EventRoleMangViewModel();
            vm.CreateModel = new EventRoleMangCreateModel();
            return View(vm);
        }

        [Log(LogActionChineseName.編輯)]
        public IActionResult Edit(string submitBtn, EventRoleMangViewModel vm)
        {
        ...
        public IActionResult GetSearchResult(EventRoleMangViewModel vm)
        {
            ...
            foreach (EventRoleMangResultModel item in vm.ResultModel)
            {
            ...
            if (vm.ConditionModel.MenuNode != null) {
                ...
                List<EventRoleMangResultModel> oResult = new List<EventRoleMangResultModel>();
        ...
        [ValidateInput(false)]
        public IActionResult SaveNewData(EventRoleMangViewModel vm)
        {
            try
            {
        ...
        [ValidateInput(false)]
        public IActionResult EditOldData(EventRoleMangViewModel vm)
        {
            try
            {
                dbAccess.DbaInitialTransaction();
